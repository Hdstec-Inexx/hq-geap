...
Produção usa `Dockerfile` (API, porta 3015) e `Dockerfile.web` (UI nginx, porta 8025) porque a API e a interface compartilham paths. Guia: [`docs/deploy/easypanel.md`](./docs/deploy/easypanel.md). Referência Compose: `compose.easypanel.yaml`.
